...
class HROperations {
    ...
    static async create(client, { operation_type, salary, date, employee_id, department_id, position_id }, userId) {
    ...
    static async update(client, id, { operation_type, salary, date, employee_id, department_id, position_id }, userId) {
