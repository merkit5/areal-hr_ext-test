...
class Address {
    ...
    static async create(client, { region, locality, street, house, building, apartment, employee_id }, userId = 1) {
    ...
    static async updateFull(client, employee_id, { region, locality, street, house, building, apartment }, userId = 1) {
